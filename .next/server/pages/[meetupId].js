...
// CONCATENATED MODULE: ./components/meetups/MeetupDatail.js
...
/* harmony default export */ var MeetupDatail = (MeetupDetail);
...
const Details = props => {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])(external_react_["Fragment"], {
    ...
    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])(MeetupDatail, {
...
const getStaticPaths = async () => {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Saman:nepal123@cluster0.o3wjp.mongodb.net/meetupDataBase?retryWrites=true&w=majority");
  const db = client.db();
...
const getStaticProps = async context => {
  ...
  const selectedMeetup = await meetupsCollection.findOne({
    _id: Object(external_mongodb_["ObjectId"])(meetupId) //converted string meetupID to object ID using ObjectId()
...
/* harmony default export */ var _meetupId_ = __webpack_exports__["default"] = (Details);
